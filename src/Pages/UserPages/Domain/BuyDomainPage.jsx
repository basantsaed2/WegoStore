...
const BuyDomainPage =()=>{
    ...
    useEffect(() => {
     ...
     const fetchStoresData = async () => {
        setIsLoading(true);
        try {
               const response = await axios.get(' https://bcknd.wegostores.com/public/user/v1/store', {
                      headers: {
    ...
    const handleAddToCart = async(domain,event) => {
        ...
        try {
            const response = await axios.post(
                ' https://bcknd.wegostores.com/public/user/v1/cart/pending',
                {
    ...
    const fetchData = async () => {
        setIsLoading(true);
        try {
               const response = await axios.get(' https://bcknd.wegostores.com/public/user/v1/domains/my_domains', {
                      headers: {
                             Authorization: `Bearer ${auth.user.token}`,
                      },
               });
    ...
    const handleSubmitAdd = async (event) => {
        ...
        setIsLoading(true);
        try {
            const response = await axios.post(' https://bcknd.wegostores.com/public/user/v1/domains/add_domain',formData, {
                headers: {
                    Authorization: `Bearer ${auth.user.token}`,
