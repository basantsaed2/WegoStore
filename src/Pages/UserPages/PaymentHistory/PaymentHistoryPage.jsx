...
//     const [storeChanged, setStoreChanged] = useState(false);
    ...
    const fetchData = async () => {
        setIsLoading(true);
        try {
               const response = await axios.get(i18n.language==="ar" ? ' https://bcknd.wegostores.com/public/user/v1/payment/history?locale=ar' :' https://bcknd.wegostores.com/public/user/v1/payment/history', {
                      headers: {
