...
const PaymentMethodPage = () => {
    ...
    const fetchData = async () => {
        setIsLoading(true);
        try {
               const response = await axios.get(' https://bcknd.wegostores.com/public/admin/v1/payment/method/show', {
                      headers: {
    ...
    const handleCloseDialog = () => {
       ...
       const deletePayment = async (paymentId, authToken) => {
              try {
                const response = await axios.delete(` https://bcknd.wegostores.com/public/admin/v1/payment/method/delete/${paymentId}`, {
                        headers: {
