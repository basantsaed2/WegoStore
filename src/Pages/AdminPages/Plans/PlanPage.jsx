...
const PlanPage = () => {
    ...
    const fetchData = async () => {
        setIsLoading(true);
        try {
               const response = await axios.get(i18n.language==='en'?' https://bcknd.wegostores.com/public/admin/v1/plan/show':' https://bcknd.wegostores.com/public/admin/v1/plan/show?locale=ar', {
                      headers: {
    ...
    const handleOpenDialog = (planId) => {
       ...
       const deletePlan = async (planId, authToken) => {
              console.log(planId)
              try {
                     const response = await axios.delete(` https://bcknd.wegostores.com/public/admin/v1/plan/delete/${planId}`, {
                            headers: {
