...
const StoresPage = () => {
    ...
    const fetchData = async () => {
        setIsLoading(true);
        try {
               const response = await axios.get(' https://bcknd.wegostores.com/public/admin/v1/store/show/approve', {
                      headers: {
    ...
    const handleCloseDialog = () => {
       ...
       const deleteStore = async (storeId, authToken) => {
              try {
                const response = await axios.delete(` https://bcknd.wegostores.com/public/admin/v1/store/delete/${storeId}`, {
                        headers: {
