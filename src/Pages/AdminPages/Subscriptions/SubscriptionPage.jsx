...
const SubscriptionPage = () => {
    ...
    const fetchData = async () => {
        setIsLoading(true);
        try {
               const response = await axios.get(' https://bcknd.wegostores.com/public/admin/v1/subscripe', {
                      headers: {
    ...
    const handleCloseDialog = () => {
       ...
       const deleteUser = async (userId, authToken) => {
              try {
                     const response = await axios.delete(` https://bcknd.wegostores.com/public/admin/v1/subscripe/delete/${userId}`, {
                            headers: {
