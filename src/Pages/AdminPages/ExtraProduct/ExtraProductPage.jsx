...
const ExtraProductPage = () => {
    ...
    const fetchData = async () => {
        setIsLoading(true);
        try {
               const response = await axios.get(i18n.language==='en'? 'https://bcknd.wegostores.com/public/admin/v1/extra/show':'https://bcknd.wegostores.com/public/admin/v1/extra/show?locale=ar', {
                      headers: {
    ...
    const handleCloseDialog = () => {
       ...
       const deleteProduct = async (productId, authToken) => {
              try {
                     const response = await axios.delete(` https://bcknd.wegostores.com/public/admin/v1/extra/delete/${productId}`, {
                            headers: {
