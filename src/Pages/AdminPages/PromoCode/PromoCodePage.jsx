...
const PromoCodePage = () => {
    ...
    const fetchData = async () => {
        setIsLoading(true);
        try {
               const response = await axios.get(' https://bcknd.wegostores.com/public/admin/v1/promoCode/show', {
                      headers: {
    ...
    const handleCloseDialog = () => {
       ...
       const deletePromoCode = async (codeId, authToken) => {
              try {
                     const response = await axios.delete(` https://bcknd.wegostores.com/public/admin/v1/promoCode/delete/${codeId}`, {
                            headers: {
