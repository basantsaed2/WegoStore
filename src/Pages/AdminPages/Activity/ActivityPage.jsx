...
const ActivityPage = () => {
    ...
    const fetchData = async () => {
        setIsLoading(true);
        try {
               const response = await axios.get(' https://bcknd.wegostores.com/public/admin/v1/activity', {
                      headers: {
    ...
    const handleCloseDialog = () => {
       ...
       const deleteActivity = async (activityId, authToken) => {
              try {
                     const response = await axios.delete(` https://bcknd.wegostores.com/public/admin/v1/activity/delete/${activityId}`, {
                            headers: {
