...
const DomainRequestPage = () => {
    ...
    const fetchData = async () => {
        setIsLoading(true);
        try {
            const response = await axios.get(' https://bcknd.wegostores.com/public/admin/v1/domains', {
                headers: {
        ...
        try {
            if (selectedOption === "Approve") {
                ...
                const response = await axios.put(
                    ` https://bcknd.wegostores.com/public/admin/v1/domains/approve/${selectedDomain.id}`,
                ...
                const response = await axios.put(
                    ` https://bcknd.wegostores.com/public/admin/v1/domains/rejected/${selectedDomain.id}`,
                    formData,
                    {
                        headers: {
                            Authorization: `Bearer ${auth.user.token}`,
