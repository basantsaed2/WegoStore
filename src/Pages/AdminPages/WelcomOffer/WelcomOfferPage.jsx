...
const WelcomeOfferPage = () => {
        ...
        setIsLoading(true);
        try {
               const response = await axios.get(' https://bcknd.wegostores.com/public/admin/v1/welcome_offer', {
                      headers: {
        ...
        const deleteOffer = async (offerId, authToken) => {
               try {
                      const response = await axios.delete(` https://bcknd.wegostores.com/public/admin/v1/welcome_offer/delete/${offerId}`, {
                             headers: {
