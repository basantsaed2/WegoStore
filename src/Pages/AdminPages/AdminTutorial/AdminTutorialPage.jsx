...
const AdminTutorialPage = () => {
  ...
  const fetchData = async () => {
    setIsLoading(true);
    try {
      const response = await axios.get(' https://bcknd.wegostores.com/public/admin/v1/tutorial_group', {
        headers: {
  ...
  const handleDeleteGroup = async (groupId) => {
    ...
    const deleteGroup = async (groupId, authToken) => {
           try {
                  const response = await axios.delete(` https://bcknd.wegostores.com/public/admin/v1/tutorial_group/delete/${groupId}`, {
                         headers: {
    ...
    const deleteTutorial = async (tutorialId, authToken) => {
          try {
                  const response = await axios.delete(` https://bcknd.wegostores.com/public/admin/v1/tutorial/delete/${tutorialId}`, {
                        headers: {
                                Authorization: `Bearer ${authToken}`,
                        },
                  });
