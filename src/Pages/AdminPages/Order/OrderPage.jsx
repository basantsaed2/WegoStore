...
const [isDropdownVisible, setDropdownVisible] = useState(false);
    ...
    const fetchData = async () => {
        setIsLoading(true);
        try {
               const response = await axios.get(' https://bcknd.wegostores.com/public/admin/v1/order/show', {
                      headers: {
    ...
    const updateOrderStatus = async (status,orderId) => {
        ...
        setIsLoading(true);
        try {
            const response = await axios.post(` https://bcknd.wegostores.com/public/admin/v1/order/update/${orderId}`,{
             order_status:status
            }, {
                headers: {
                    Authorization: `Bearer ${auth.user.token}`,
    ...
    const handleStatusStoreChange = async (status,orderId) => {
        ...
        setIsLoading(true);
        try {
            const response = await axios.post(` https://bcknd.wegostores.com/public/admin/v1/store/approve`,{
