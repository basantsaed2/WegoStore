...
const UserPage = () => {
    ...
    const fetchData = async () => {
        setIsLoading(true);
        try {
               const response = await axios.get(' https://bcknd.wegostores.com/public/admin/v1/users/view', {
                      headers: {
    ...
    const handleLoginUserClick = async (userId) => {
        try {
          ...
          const response = await axios.get(` https://bcknd.wegostores.com/public/admin/v1/users/user_login/${userId}`,
                {
                        headers: {
                               Authorization: `Bearer ${auth.user.token}`,
                        },
    ...
    const handleCloseDialog = () => {
       ...
       const deleteUser = async (userId, authToken) => {
              try {
                     const response = await axios.delete(` https://bcknd.wegostores.com/public/admin/v1/users/delete/${userId}`, {
                            headers: {
        ...
        const handleStatusChange = async (e, userId) => {
                ...
                ` https://bcknd.wegostores.com/public/admin/v1/users/status/${userId}`,
                {status: newStatus },
                {
                headers: {
                        Authorization: `Bearer ${auth.user.token}`,
