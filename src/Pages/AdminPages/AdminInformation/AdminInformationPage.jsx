...
const AdminInformationPage = () => {
    ...
    const fetchData = async () => {
        setIsLoading(true);
        try {
               const response = await axios.get(' https://bcknd.wegostores.com/public/admin/v1/contact_us', {
                      headers: {
    ...
    const handleCloseDialog = () => {
       ...
       const deleteContact = async (contactId, authToken) => {
              try {
                const response = await axios.delete(` https://bcknd.wegostores.com/public/admin/v1/contact_us/delete/${contactId}`, {
                        headers: {
