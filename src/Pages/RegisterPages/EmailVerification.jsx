...
//     try {
//       const response = await axios.post(' https://bcknd.wegostores.com/public/user/v1/signUp/code', { email });
...
//         await axios.post(
//             " https://bcknd.wegostores.com/public/user/v1/signUp/code",
//             { email },
...
//         // Verify Code API
//         const response = await axios.post(" https://bcknd.wegostores.com/public/user/v1/signUp/code", {
//             email,
...
//             await axios.post(
//                 " https://bcknd.wegostores.com/public/user/v1/signUp",
...
//         await axios.post(" https://bcknd.wegostores.com/public/user/v1/signUp/resend_code", { email });
