...
const EditExtraProductLayout =()=>{
    ...
    const fetchData = async () => {
        setIsLoading(true);
        try {
               const response = await axios.get(' https://bcknd.wegostores.com/public/admin/v1/extra/show', {
                      headers: {
    ...
    const fetchData_ar = async () => {
       setIsLoading(true);
       try {
              const response = await axios.get(' https://bcknd.wegostores.com/public/admin/v1/extra/show?locale=ar', {
                     headers: {
                            Authorization: `Bearer ${auth.user.token}`,
                     },
              });
